<x-filament-panels::page>
    <style>
        :root {
            --spacing-gr-xs: 8px;
            /* 0.5rem - base / tight space */
            --spacing-gr-sm: 13px;
            /* 0.8125rem - list item padding / minor gap */
            --spacing-gr-md: 21px;
            /* 1.3125rem - card padding / major gap */
            --spacing-gr-lg: 34px;
            /* 2.125rem - section spacing / wrapper margin */
            --spacing-gr-xl: 55px;
            /* 3.4375rem - generous page card padding */
        }
        ...
        /* Dark/Light mode text color helpers */
        .review-text-heading {
            color: rgb(31, 41, 55);
        }

        .dark .review-text-heading {
        ...
        .dark .review-text-muted {
            color: rgb(156, 163, 175);
        }

        /* Iframe preview container background */
        .review-iframe-wrapper {
            background-color: rgb(249, 250, 251);
        }

        .dark .review-iframe-wrapper {
            background-color: rgb(3, 7, 18);
        }

        /* Icon boxes */
        .review-icon-primary-box {
            background-color: var(--primary-50);
            color: var(--primary-600);
        }

        .dark .review-icon-primary-box {
            background-color: color-mix(in srgb, var(--primary-950) 40%, transparent);
            color: var(--primary-400);
        }

        .review-icon-amber-box {
            background-color: rgb(254, 243, 199);
            color: rgb(217, 119, 6);
        }

        .dark .review-icon-amber-box {
        ...
        .dark .review-timeline-line {
            border-color: rgba(255, 255, 255, 0.1);
            /* background-color: rgba(255, 255, 255, 0.1); */
        }

        .review-status-approved-badge {
            background-color: rgb(236, 253, 245);
            color: rgb(4, 120, 87);
        }

        .dark .review-status-approved-badge {
            background-color: rgba(6, 78, 59, 0.3);
            color: rgb(52, 211, 153);
        }

        .review-status-revision-badge {
            background-color: rgb(254, 243, 199);
            color: rgb(180, 83, 9);
        }

        .dark .review-status-revision-badge {
            background-color: rgba(120, 53, 15, 0.3);
            color: rgb(251, 191, 36);
        }

        .review-recipient-chip {
            background-color: rgb(243, 244, 246);
            color: rgb(55, 65, 81);
            border: 1px solid rgba(229, 231, 235, 0.5);
        }

        .dark .review-recipient-chip {
